...
def apply_liquid_glass_theme(
    ...
    st.markdown(
        ...
        :root {{
            ...
            --glass-hairline: rgba(226, 232, 240, 0.16);
            --glass-hairline-soft: rgba(226, 232, 240, 0.10);
        ...
        [data-testid="stTable"] {{
            background: linear-gradient(180deg, rgba(8, 15, 34, 0.34), rgba(8, 15, 34, 0.18)) !important;
            border-radius: 14px !important;
            border: 1px solid var(--glass-hairline) !important;
            box-shadow: 0 12px 34px rgba(0, 0, 0, 0.16) !important;
            overflow: hidden !important;
            --table-inset-x: 1rem;
            padding: 2.05rem var(--table-inset-x) 0.72rem var(--table-inset-x) !important;
        ...
        [data-testid="stDataFrame"] [data-testid="stElementToolbar"] {{
            ...
            top: var(--table-inset-x) !important;
            right: var(--table-inset-x) !important;
            z-index: 8 !important;
        ...
        [data-testid="stDeckGlJsonChart"] {{
            ...
            border-radius: 14px !important;
            box-shadow: 0 12px 34px rgba(0, 0, 0, 0.16) !important;
            padding: 1rem 1.85rem 0.9rem 1.25rem !important;
            margin-top: 0.65rem !important;
